...
- `Exhibicionismo, voyeurismo y lugares`
...
The exhibitionism migration keeps the 20 active final practices and separates consensual watching/visibility; images, recording and digital distance; private-place changes of setting; and controlled exposure or dedicated sexual venues. It introduces the reusable `anonymity` signal because concealed identity or unfamiliarity is meaningfully different from simple visibility. That signal also enriches previously migrated masks, anonymous-group scenes and strangers roleplay. No extra location questions are added because the existing private, semi-public and venue-based options already cover the meaningful contextual differences without multiplying near-identical places.
