export const ES_QUESTIONNAIRE_UX_TRANSLATIONS = {
  ...
  'questionnaire.categories.consentNotice': 'El catálogo presupone participantes adultos y consentimiento. Si una práctica incluye sorpresa, un momento no anunciado, exposición, disponibilidad o pérdida de control, se entiende siempre dentro de límites acordados y con consentimiento previo. Cuando ese contexto cambia la práctica, se indica en su descripción.',
...
export const EN_QUESTIONNAIRE_UX_TRANSLATIONS = {
  ...
  'questionnaire.categories.consentNotice': 'The catalogue assumes adult participants and consent. If a practice includes surprise, an unannounced moment, exposure, availability or loss of control, it is always understood to happen within agreed limits and with prior consent. When that context changes the practice, its description says so.',
