export const ES_SEMANTIC_DASHBOARD_TRANSLATIONS = {
  ...
  'dashboard.semantic.coordinates': 'Mapa de coordenadas',
  'dashboard.semantic.coordinatesDescription': 'Los dos ejes comparan el peso relativo de familias de señales con afinidad positiva. Estar cerca de un lado no implica rechazo del contrario.',
...
export const EN_SEMANTIC_DASHBOARD_TRANSLATIONS: Readonly<Record<SemanticDashboardTranslationKey, string>> = {
  ...
  'dashboard.semantic.coordinates': 'Coordinate map',
  'dashboard.semantic.coordinatesDescription': 'The two axes compare the relative weight of positively rated signal families. Being near one side does not imply rejection of the other.',
