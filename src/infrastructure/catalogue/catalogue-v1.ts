  ...
  catalogue: {
    ...
    practices: [
      ...
      },
      {
        ...
        categoryId: 'toys',
        label: 'Vibrator',
        description: 'Using a vibrator on oneself or a partner.',
        roles: [
          { id: 'use-on-partner', label: 'Use it on my partner', perspective: 'active' },
          { id: 'use-on-self', label: 'Have it used on me / use it on myself', perspective: 'receptive' },
        ],
      ...
      },
      {
        ...
        categoryId: 'toys',
        label: 'Dildo',
        description: 'Using a dildo on oneself or a partner.',
        roles: [
          { id: 'use-on-partner', label: 'Use it on my partner', perspective: 'active' },
          { id: 'use-on-self', label: 'Have it used on me / use it on myself', perspective: 'receptive' },
        ],
