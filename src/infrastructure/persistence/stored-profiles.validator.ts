...
import { MAX_STORED_PROFILES, PROFILE_STORE_VERSION, StoredProfilesV6 } from './profile-store';

const STORE_KEYS = ['version', 'profiles'] as const;

export class StoredProfilesValidator extends Validator<StoredProfilesV6> {
